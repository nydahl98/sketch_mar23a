/*
===================================================================================
library to control the AD4116 ADC
...
#ifndef _AD4116_H_INCLUDED
#define _AD4116_H_INCLUDED
...
public:
	...
	=====================================
	*/
	AD4116Class() : m_data_mode(CONTINUOUS_CONVERSION_MODE), append_status_reg(false) {
		/* ... */
	}
